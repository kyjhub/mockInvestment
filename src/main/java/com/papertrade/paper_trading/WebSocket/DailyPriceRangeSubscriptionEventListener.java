...
public class DailyPriceRangeSubscriptionEventListener {

    private static final Pattern DAILY_PRICE_RANGE_DESTINATION_PATTERN =
        Pattern.compile("^/topic/daily-price-range/([A-Za-z0-9.\\-]+)$");
    ...
    public void handleSubscribe(SessionSubscribeEvent event) {
        ...
        Matcher matcher = DAILY_PRICE_RANGE_DESTINATION_PATTERN.matcher(destination);
        if (matcher.matches()) {
