...
public class OrderBookSubscriptionEventListener {

    private static final Pattern ORDER_BOOK_DESTINATION_PATTERN =
        Pattern.compile("^/topic/orderbook/([A-Za-z0-9.\\-]+)$");
    ...
    public void handleSubscribe(SessionSubscribeEvent event) {
        ...
        Matcher matcher = ORDER_BOOK_DESTINATION_PATTERN.matcher(destination);
        if (matcher.matches()) {
