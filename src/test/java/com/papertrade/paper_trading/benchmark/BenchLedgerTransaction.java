...
/**
 * {@code LedgerTransaction}을 {@code SEQUENCE}로 바꾼 형태. 벤치마크 전용이다.
 *
...
public class BenchLedgerTransaction {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "bench_ledger_tx_seq")
    @SequenceGenerator(name = "bench_ledger_tx_seq", sequenceName = "bench_ledger_tx_seq",
        allocationSize = 50)
    private Long id;
